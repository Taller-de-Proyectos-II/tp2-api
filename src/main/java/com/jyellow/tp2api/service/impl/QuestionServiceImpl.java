...
public class QuestionServiceImpl implements QuestionService {
	...
	public void createDefault() {
		...
		if(defaultCreation == false) {
			...
			questions.add(new Question(0, "Me siento más intranquilo(a) y nervioso(a) que de costumbre", questionType, answers));
			...
			questions.add(new Question(0, "Creo que todo está bien y que no va a pasar nada malo", questionType, answers));
			...
			questions.add(new Question(0, "Me siento tranquilo(a) y me es fácil estarme quieto(a)", questionType, answers));
			...
			questions.add(new Question(0, "Se me duermen y me hormiguean los dedos de las manos y de los pies", questionType, answers));
