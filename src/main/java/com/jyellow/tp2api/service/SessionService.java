...
public interface SessionService {
	...
	List<SessionDTO> listByPsychologistUserLoginDniAndAceptedAndFinishedAndPatientUserLoginDni(String psychologistDni, boolean acepted, boolean finished, String patientDni);
